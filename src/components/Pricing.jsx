    ...
    const packages = [
        {
            ...
            red: "/src/assets/Rectangle 22.png"
        },
        {
            name: "Advanced",
            monthlyPrice: "39",
    ...
    return (
        <div className="md:px-14 p-4 max-w-s mx-auto py-10" id="pricing">
            <div className="text-center">
                <h2 className="md:text-5xl text-3xl font-extrabold text-primary mb-2">Here are all our plans
                </h2>
                <p className="text-tertiary md:w-1/3 mx-auto px-4">A simple paragraph is comprised of three
                    major components. The which is often a declarative sentence.</p>
                ...
                <div className="mt-16">
                    <label htmlFor="toggle" className="inline-flex items-center cursor-pointer">
                        ...
                        <div className="w-14 h-6 bg-gray-200 rounded-full transition duration-200 ease-in-out">
                            <div className={`w-6 h-6 rounded-full transition duration-200 ease-in-out ${isYearly ? "bg-primary ml-8" :
                                "bg-gray-500"}`}></div>
                        </div>
                ...
                className="grid sm:grid-cols-2 lg:grid-cols-3 gap-10 mt-20 md:w-11/12 mx-auto">
                {
                    ...
                    rounded-lg shadow-3xl">
                        ...
                        <p className="mt-5 text-center text-secondary text-4xl font-bold">
                            ...
                            text-tertiary font-medium">{isYearly ? "year" : "month"}</span>
                        </p>
                        <ul className="mt-4 space-y-2 px-4">
                            ...
                            <li className="flex gap-3 items-center">
                                <img src={pkg.red} alt="" className="w-4 h-4" />
