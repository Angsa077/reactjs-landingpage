    ...
    return (
        <div className="bg-[#010851] md:px-14 p-4 max-w-screen-2xl mx-auto text-white">
            <div className="my-12 flex flex-col md:flex-row gap-10">
                <div className="m:w1/2 space-y-8">
                    ...
                    <div>
                        ...
                        <input type="submit" value="Subscribe" className="bg-secondary py-2 px-4 rounded-md -ml-2
                ...
                <div className="md:w-1/2 flex flex-col md:flex-row flex-wrap justify-between gap-8 items-start">
                    ...
                    <div className="space-y-4 mt-5">
                        ...
                        <ul className="space-y-3">
                            <p className="hover:text-gray-300">0877-4100-1100</p>
                            <p className="hover:text-gray-300">angsa0077@gmail.com</p>
                            <p className="hover:text-gray-300">Serang, Banten Indonesia</p>
                            <p className="hover:text-gray-300">42191</p>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-8 sm:items-center justify-between my-8">
                <p>© 2023 Angsa77. All Rights Reserved</p>
